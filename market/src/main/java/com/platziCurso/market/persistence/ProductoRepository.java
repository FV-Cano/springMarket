...
public class ProductoRepository implements ProductRepository {
    ...
    // -----------------------------
    // Los métodos anteriores fueron desarrollados en la interfaz de ProductoCrudRepository porque son QueryMethods codeados por el desarrollador. El resto no es necesario desarrollarlos porque vienen de forma nativa gracias a SpringData.
